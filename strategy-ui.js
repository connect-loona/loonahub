(function () {
  ...
  function ensureWorkspaceStyles() {
    ...
    style.textContent = [
      "#page-strategy{background:#212121;color:#ececec}",
      "#so-root{font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:14px;line-height:1.55;color:#ececec}",
      "#so-root .section-title{font-size:24px;line-height:1.25;letter-spacing:-.02em;color:#fff}",
      "#so-root .note{font-size:13px;line-height:1.55;color:#b4b4b4}",
      "#so-root .btn{font-size:13px;min-height:38px}",
      "#so-root .btn-ghost{background:#2f2f2f;border-color:#4a4a4a;color:#ececec}",
      "#so-root .btn-ghost:hover{background:#3a3a3a}",
      "#so-root .form-control{background:#2f2f2f;border-color:#4a4a4a;color:#fff;font-size:14px}",
      "#so-root .form-control::placeholder{color:#8f8f8f}",
      ".so-stage-rail{background:#2f2f2f!important;border-color:#444!important}",
      ".so-workspace{grid-template-columns:minmax(190px,220px) minmax(0,1fr) minmax(240px,280px)!important}",
      ".so-workspace-main{max-width:860px;width:100%;margin:0 auto;padding:0 12px}",
      ".so-workspace-main>.att-board{background:transparent;border:0;border-bottom:1px solid #3f3f3f;border-radius:0;padding:20px 6px;margin-bottom:6px;font-size:14px;line-height:1.6}",
      ".so-workspace-main>.att-board .bh{font-size:18px;line-height:1.35;letter-spacing:-.01em;margin-bottom:12px;color:#fff}",
      ".so-workspace-main .pf-absrow{font-size:15px;line-height:1.55;padding:14px 0!important}",
      ".so-workspace-main .pf-absrow>div:first-child{font-size:15px;line-height:1.5;color:#fff}",
      ".so-workspace-main [style*='font-size:12px']{font-size:13px!important;line-height:1.55;color:#b4b4b4!important}",
      ".so-workspace-main [style*='font-size:11px']{font-size:12px!important;line-height:1.5}",
      ".so-workspace-side{background:#2f2f2f!important;border-color:#444!important;font-size:13px;line-height:1.5}",
      ".so-workspace-side .bh{font-size:16px;line-height:1.35;color:#fff}",
      ".so-memory-label{font-size:11px!important;letter-spacing:.04em!important;text-transform:none!important;font-weight:650;color:#b4b4b4!important}",
      ".so-memory-value,.so-memory-link{font-size:13px!important;line-height:1.5!important;color:#ececec}",
      ".so-memory-link{border-color:#444!important}",
      ".so-review-panel textarea{font-size:14px;line-height:1.5}",
      ".so-stage-step{font-size:13px!important;color:#b4b4b4}",
