// strategy-brand-discover — runs on Netlify's current Functions runtime.
//
// The handler itself is unchanged, in _legacy/strategy-brand-discover.js. withLambda converts the incoming
