// strategy-stage-approve — runs on Netlify's current Functions runtime.
//
// The handler itself is unchanged, in _legacy/strategy-stage-approve.js. withLambda converts the incoming
