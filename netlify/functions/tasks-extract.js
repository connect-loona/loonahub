...
- "due_date": "YYYY-MM-DD" if a date or relative date (e.g. "tomorrow", "by Friday", "next week") is mentioned, computed relative to today's date, else an empty string

Reply with ONLY valid JSON, no markdown fences, no commentary, matching this exact shape: {"tasks": [{"task": "...", "assignee": "...", "brand": "...", "due_date": "..."}]}. If the transcript names multiple tasks, return all of them. If nothing actionable is found, return {"tasks": []}.`,
        messages: [
