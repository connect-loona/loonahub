// strategy-stage-retry — runs on Netlify's current Functions runtime.
//
// The handler itself is unchanged, in _legacy/strategy-stage-retry.js. withLambda converts the incoming
...
import legacy from "./_legacy/strategy-stage-retry.js";
